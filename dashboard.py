...
p="""select * from register where id='%s'"""%(pid)
cur.execute(p)
rec=cur.fetchall()
for i in rec:
        print("""<!DOCTYPE html>
        ...
        <body>
            ...
            <div class="navbars">
                ...
                <div><a href="dashboard.py?id=%s"><i class="glyphicon glyphicon-home" style="padding-top: 7px;"></i> Home</a></div>                
                <div><a href="login.py?id=%s"><i class="glyphicon glyphicon-user " style="padding-top: 7px;"></i>Logout</a></div>
                <div><a href="dashfood.py?id=%s"><i class="glyphicon glyphicon-shopping-cart" style="padding-top: 7px;"></i></a></div>
            </div>
            ...
            <a href="dashboard.py?id=%s"><i class="glyphicon glyphicon-home" style="padding-top: 7px;"></i></a>&nbsp;&nbsp;       
             <a href="login.py?id=%s"><i class="glyphicon glyphicon-user login-min" style="padding-top: 7px;"></i></a> &nbsp;&nbsp;
            <a href="dashfood.py?id=%s"><i class="glyphicon glyphicon-shopping-cart" style="padding-top: 7px;"></i></a>
        </div>
            </div>
...
for i in red:
        ...
        <footer>
            <a href="demo.py?id=%s&cid=%s&img=%s&pct=%s&sd=%s&act=%s&dis=%s">
            <button class="btn btn-danger cart-btn btn-lg"> ADD CART</button></a>
        </footer>

    </div>
        """ %(i[1],i[2],i[3],i[4],i[5],pid,i[0],i[1],i[2],i[3],i[4],i[5]))
print("""</div>""")
