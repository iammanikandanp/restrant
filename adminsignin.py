...
for i in rec:
    ...
    <body>
        ...
        <div class="navbars">
            ...
            <div> <a href='admindashb.py?id=%s'><i class="glyphicon glyphicon-home" style="padding-top: 7px;"></i> Home</a></div>     
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12 loginpage ">
                    <form enctype="multipart/form-data" method="post">
                        <h1 class="texts">Admin SignIn</h1>
                        <hr>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group ">
                                <label for="inputZip">Branchcode</label>
                                <input type="text" class="form-control" name="bcode" id="inputZip" placeholder="example 001">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-group">
...
branchcode = p.getvalue("bcode")
submit = p.getvalue("sub")
if submit != None:
    b = """insert into adminreg (name,email,password,address,city,branchcode) values ('%s','%s','%s','%s','%s','%s')""" % (username, email, passwords,address, city,branchcode)
    cur.execute(b)
    con.commit()
