...
if submit != None:
    b="""insert into register (name,email,password,dob,gender,address,city,state,pincode) values ('%s','%s','%s','%s','%s','%s','%s','%s','%s')"""%(username,email,passwords,dob,gender,address,city,state,pincode)
    cur.execute(b)
    con.commit()
